...
<!--                    Карты нуждаются в реализации с помощью java script-->
                ...
                <div class="about-text">
                    ...
                    <div class="col l6 about-adress">
                        ...
                        <span class="fs20 fc-dark-brown"><?= $listAddress[$i]['address']?><br>
                            <?=Yii::t('models/client', 'Phone')?><br><?=$listAddress[$i]['phones']?><br>
                            <?=Yii::t('shop/setting', 'schedule')?><br><?= $listAddress[$i]['schedule']?>
                        </span>
                    </div>
                    <?php endfor;?>
                    <?php endif;?>
