...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $bannerSetting = ShopSettingTable::getSettingValue('banner');
        if ($bannerSetting) {
            $bannerSetting = json_decode($bannerSetting);
            $bannerTitle = $bannerSetting->bannerTitle;
            $bannerFile = $bannerSetting->bannerFile ? FileManager::getInstance()->getStorageUrl() . $bannerSetting->bannerFile : '';
        }
