...
$('button#btn_add_phone').click(function () {
    var index = $('.form-inline').children('input').length;
    console.log(index);

    var html = '<div class="form-inline">'+
        '<input type="text" id="clientmodel-phones_arr-' + index + '" class="form-control" name="ClientModel[phones_arr][' + index + ']" data-plugin-inputmask="inputmask_c6d7b205">'+
