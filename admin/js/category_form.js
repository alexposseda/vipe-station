...
$('#add-character').on('click', function(){
    ...
    $('#new-character-list').append('<div class="character-line" id="character-'+index+'"><div class="form-group field-productcharacteristicmodel-'+index+'-title required"><label class="control-label" for="productcharacteristicmodel-'+index+'-title">Новая характеристика</label><div class="row no-margin"><div class="col-lg-6 col-md-6 col-sm-12 "><input type="text" id="productcharacteristicmodel-'+index+'-title" class="form-control" name="ProductCharacteristicModel['+index+'][title]" placeholder="Название"></div><div class="col-lg-4"><input type="hidden" name="ProductCharacteristicModel['+index+'][isOption]" value="0"><label><input type="checkbox" id="productcharacteristicmodel-'+index+'-isoption" name="ProductCharacteristicModel['+index+'][isOption]" value="1"> Is Option</label></div><div class="col-sm-3 col-md-2 col-lg-2"><button type="button" class="btn btn-sm btn-danger del-character" data-index="'+index+'"><span class="glyphicon glyphicon-remove"></span></button></div></div><div class="help-block"></div></div><input type="hidden" id="productcharacteristicmodel-'+index+'-id" name="ProductCharacteristicModel['+index+'][id]"></div>');
