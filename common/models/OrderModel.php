<?php
	 ...
	 * @property OrderClientDataModel $orderClientData
	...
	class OrderModel extends ActiveRecord{
		 ...
		 * @return \yii\db\ActiveQuery
		 */
		public function getOrderClientData() {
			return $this->hasOne( OrderClientDataModel::className(), [ 'order_id' => 'id' ] );
		}
